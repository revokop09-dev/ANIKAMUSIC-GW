...
def load_fonts():
    try:
        return {
            "cfont": ImageFont.truetype("anikamusic/assets/cfont.ttf", 24),
            "tfont": ImageFont.truetype("anikamusic/assets/font.ttf", 30),
        }
...
FALLBACK_IMAGE_PATH = "anikamusic/assets/controller.png"
...
async def add_controls(img: Image.Image) -> Image.Image:
    ...
    region = img.crop(box)
    try:
        controls = Image.open("anikamusic/assets/controls.png").convert("RGBA")
